...
user_cnn_conv_layers *user_cnn_layers_convolution_create(user_cnn_layers *cnn_layers, int kernel_width, int kernel_height ,int feature_number){
	...
	user_nn_matrices_rand_vaule(conv_layers->kernel_matrices, (float)(conv_layers->feature_number + conv_layers->input_feature_number) * conv_layers->kernel_width * conv_layers->kernel_height);//对卷积核进行初始化
...
user_cnn_full_layers *user_cnn_layers_fullconnect_create(user_cnn_layers *cnn_layers){
	...
	user_nn_matrix_rand_vaule(full_layers->kernel_matrix, (float)full_layers->feature_number + full_layers->feature_number);//初始化全连接的权重值
...
user_cnn_output_layers *user_cnn_layers_output_create(user_cnn_layers *cnn_layers, int class_number){
	...
	user_nn_matrix_rand_vaule(output_layers->kernel_matrix, (float)output_layers->feature_number + output_layers->class_number);//初始化输出层kernel模板
