...
user_rnn_hidden_layers *user_rnn_layers_hidden_create(user_rnn_layers *rnn_layers,int feature_number, int time_number) {
	...
	user_nn_matrix_rand_vaule(hidden_layers->kernel_matrix, (float)hidden_layers->time_number + hidden_layers->time_number);//初始化全连接的权重值
	user_nn_matrix_rand_vaule(hidden_layers->kernel_matrix_t, (float)hidden_layers->time_number + hidden_layers->time_number);//初始化全连接的权重值
	user_nn_matrix_rand_vaule(hidden_layers->biases_matrix, (float)hidden_layers->time_number + hidden_layers->time_number);//初始化全连接的权重值
...
user_rnn_output_layers *user_rnn_layers_output_create(user_rnn_layers *rnn_layers, int feature_number, int time_number) {
	...
	user_nn_matrix_rand_vaule(output_layers->kernel_matrix, (float)output_layers->time_number + output_layers->time_number);//初始化全连接的权重值
	user_nn_matrix_rand_vaule(output_layers->biases_matrix, (float)output_layers->time_number + output_layers->time_number);//初始化全连接的权重值
