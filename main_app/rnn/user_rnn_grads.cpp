...
void user_rnn_grads_hidden(user_rnn_layers *hidden_layer, float alpha) {
	...
	user_nn_matrix_sum_matrix_mult_alpha(hidden_layers->kernel_matrix, hidden_layers->deltas_kernel_matrix, (float)-1.0f*alpha);
	user_nn_matrix_sum_matrix_mult_alpha(hidden_layers->kernel_matrix_t, hidden_layers->deltas_kernel_matrix_t, (float)-1.0f*alpha);
	user_nn_matrix_sum_matrix_mult_alpha(hidden_layers->biases_matrix, hidden_layers->deltas_biases_matrix, (float)-1.0f*alpha);
...
void user_rnn_grads_output(user_rnn_layers *output_layer, float alpha) {
	...
	user_nn_matrix_sum_matrix_mult_alpha(output_layers->kernel_matrix, output_layers->deltas_kernel_matrix, (float)-1.0f*alpha);
	user_nn_matrix_sum_matrix_mult_alpha(output_layers->biases_matrix, output_layers->deltas_biases_matrix, (float)-1.0f*alpha);
