...
void user_snn_ffp_flat(user_snn_layers *prior_layer, user_snn_layers *flat_layer) {
	...
	user_nn_matrix_thred_flat(input_feature_matrix, flat_layers->thred_kernel_matrix, flat_layers->feature_matrix);//计算值
...
void user_snn_ffp_hidden(user_snn_layers *prior_layer, user_snn_layers *hidden_layer) {
	...
	user_nn_matrix_thred_acc(input_feature_matrix, hidden_layers->thred_kernel_matrix, hidden_layers->feature_matrix);//计算值
...
void user_snn_ffp_output(user_snn_layers *prior_layer, user_snn_layers *output_layer) {
	...
	user_nn_matrix_thred_acc(input_feature_matrix, output_layers->thred_kernel_matrix, output_layers->feature_matrix);//计算值
...
void user_snn_bp_output_back_prior(user_snn_layers *prior_layer, user_snn_layers *output_layer) {
	...
	user_nn_matrix_update_thred(input_feature_matrix, input_thred_matrix, output_layers->thred_kernel_matrix, output_layers->thred_matrix, user_nn_snn_step_vaule);//更新阈值
...
void user_snn_bp_hidden_back_prior(user_snn_layers *prior_layer, user_snn_layers *hidden_layer) {
	...
	user_nn_matrix_cpy_matrix(input_thred_matrix, input_feature_matrix);//拷贝值
	//user_nn_matrix_memset(input_thred_matrix, 0.0f);
	user_nn_matrix_update_thred(input_feature_matrix, input_thred_matrix, hidden_layers->thred_kernel_matrix, hidden_layers->thred_matrix, user_nn_snn_step_vaule);//更新阈值
	user_snn_data_softmax(input_thred_matrix);
...
void user_snn_bp_flat_back_prior(user_snn_layers *prior_layer, user_snn_layers *flat_layer) {
	...
	user_nn_matrix_cpy_matrix(input_thred_matrix, input_feature_matrix);//拷贝值
	//user_nn_matrix_memset(input_thred_matrix, 0.0f);
	user_nn_matrix_update_thred(input_feature_matrix, input_thred_matrix, flat_layers->thred_kernel_matrix, flat_layers->thred_matrix, user_nn_snn_step_vaule);//更新阈值
	user_snn_data_softmax(input_thred_matrix);
	user_nn_matrix_thred_process(input_thred_matrix, input_feature_matrix, input_thred_matrix);//计算出阈值变化趋势
}
